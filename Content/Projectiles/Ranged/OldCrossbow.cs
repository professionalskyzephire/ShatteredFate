        ...
        public override void AI() {
            ...
            if (player.HeldItem.ModItem is Content.Items.Weapons.Ranged.OldCrossbow) {
                ...
                if (hasAmmo && Projectile.ai[1] == 0 && Projectile.localAI[0] <= 0) {
                    ...
                    Projectile.localAI[0] = (int)(player.HeldItem.useTime / 3f);
                ...
                float reloadTime = (Projectile.ai[0] / player.HeldItem.useTime) * 4f;
                float reloadHand = 0f;
                if (Projectile.ai[0] <= player.HeldItem.useTime / 4) {
